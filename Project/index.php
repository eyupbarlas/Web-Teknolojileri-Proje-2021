...
<body style="background-color: lightblue;">
    <nav>
        <ul class="nav nav-pills justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" href="/">Hakkında</a>
            </li>
            <li class="nav-item">
    ...
    <div id="gakgos" class="container" align="center">
        <div class="jumbotron jumbotron-fluid" style="color: brown;">
            <h1 class="display-4"> Gakgoşlar Diyarı </h1>
        </div>
    </div>
    <div id="icerik" class="container" align="center">
        <div align="center" class="row">
            <div class="col-1"></div>
            <div id="content-col" style="background-color: grey" class="col">
                <h1>Hakkında</h1>
                <p>
                ...
                <div align="center" class="img-fluid"><img width="40%" src="img/basketbol.jfif" alt="basketbol"></div>
                <p>
                ...
                <div align="center" class="img-fluid"><img width="40%" src="img/code.jfif" alt="coding"></div>
                <p>
